# Python Programming for Linguists (2020)
...
In this workshop, consisting of four videos, several exercises, and a live session, you will be introduced to Python. After a short general introduction to programming as well as Python, we will utilize Python to solve several (corpus) linguistic exercises.
...
2. Familiarize yourself with Python notebooks and try to solve exercises 1 to 3.
