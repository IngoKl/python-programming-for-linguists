...
While the materials and exercises are target at beginners, they are challenging and this workshop is designed as a intense deep dive! Please do not feel discouraged if you get stuck or if something seems too hard. I have provided solutions for all exercises and you will also find lot's of additonal helpful resources in this repository. Also, while not required, you can also prepare for this workshop by consulting other slower-paced introductory courses such as the ones listed in [this document](https://github.com/IngoKl/python-programming-for-linguists/blob/main/Links_to_Resources.md).
...
## Workshop Outline & Learning Paths

This workshop is designed as a blend of **asynchronous and synchronous elements**. However, as everything will be recorded, you can also do this completely self-paced.

The general idea is that you watch a series of videos and complete/attempt a series of exercises before joinig the synchronous live session hosted on *Twitch*. During this live session, I will be solving [Exercises 8 to 17]() wile you are invited to code along and to ask questions.
...
* [Additional Exercise: Regular Expressions](https://github.com/IngoKl/python-programming-for-linguists/blob/main/2021/exercises/Additional_Exercises_RegEx.ipynb) ([Watch the Video](https://www.youtube.com/watch?v=GGEveroG3Fg))
...
### Helpful Additional Material and Primers
